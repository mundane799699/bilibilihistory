...
import { Download, Clock, Search, RefreshCw, Lock, FileDown, BookOpen, Lightbulb, History, Share2 } from "lucide-react"
  ...
  const features = [
    {
      ...
      title: "真正无限记录",
      description: "彻底突破官方数量限制，永久保存所有B站观看历史，不再有遗漏。",
    },
    {
    ...
    },
    {
      ...
      title: "自动增量同步",
      description: "每分钟自动同步最新历史，默默守护，省心省力，不错过任何记录。",
    },
    {
      icon: <Lock className="h-6 w-6" />,
      title: "本地安全存储",
      description: "数据存储在本地IndexedDB，绝不上传，隐私至上，安全有保障。",
    },
    {
  ...
  const useCases = [
    {
      ...
      title: "学习与知识回顾 📚",
      description: "快速找回教程、科普视频，巩固学习成果。再也不用担心找不到之前看过的学习资源。",
    },
    {
      icon: <Lightbulb className="h-7 w-7 text-[#00a1d6]" />,
      title: "灵感与素材追溯 💡",
      description: "不再让一闪而过的灵感和素材溜走。随时回顾那些激发你创意的精彩内容，让灵感常驻。",
    },
    {
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 sm:gap-10">
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="font-semibold text-xl mb-3 text-gray-800">教程找不回</h3>
              <p className="text-gray-600">"上月看的烹饪教程是哪个UP主？找了好久都找不到..."</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              <div className="bg-[#b3e5fc]/20 w-16 h-16 rounded-full flex items-center justify-center mb-6">
                <Clock className="h-8 w-8 text-[#00a1d6]" />
              </div>
              <h3 className="font-semibold text-xl mb-3 text-gray-800">系列追番难</h3>
              <p className="text-gray-600">"去年追的系列视频想重温，但历史记录早就刷没了..."</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
              <div className="bg-[#b3e5fc]/20 w-16 h-16 rounded-full flex items-center justify-center mb-6">
                <RefreshCw className="h-8 w-8 text-[#00a1d6]" />
              </div>
              <h3 className="font-semibold text-xl mb-3 text-gray-800">知识点遗忘</h3>
              <p className="text-gray-600">"看过讲这知识点的视频搜不到？记不清关键词怎么办..."</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {useCases.map((useCase, index) => (
              ...
              >
                ...
                <div className="ml-6">
                  <h3 className="font-semibold text-xl mb-3 text-gray-800">{useCase.title}</h3>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            {steps.map((step, index) => (
              <div key={index} className="flex flex-col items-center text-center p-4 relative">
